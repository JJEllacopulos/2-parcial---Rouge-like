#ifndef CLASE_PERSONAJE_ENEMIGO_2_GRAFICOS_H_INCLUDED
#define CLASE_PERSONAJE_ENEMIGO_2_GRAFICOS_H_INCLUDED
...
void ENEMIGO_2::Graficar_accion_MOBs_pocicion_estatica(){
    ...
    switch(frente){
        case 0:
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, 0 * DESPLAZAR_Y_PIXEL, 0 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
        ...
        break;
        case 1:
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, 0 * DESPLAZAR_Y_PIXEL, 1 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
        ...
        break;
        case 2:
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, 0 * DESPLAZAR_Y_PIXEL, 2 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
            draw_sprite(buffer, ENEMIGO_1_mov_spr, gets_pocicion_y_juego() * TAMANO_Y_SPRITE + ESPACIO_SUPERIOR_Y, gets_pocicion_x_juego() * TAMANO_X_SPRITE + ESPACIO_SUPERIOR_X);
        break;
        case 3:
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, 0 * DESPLAZAR_Y_PIXEL, 1 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
...
void ENEMIGO_2::Graficar_accion_MOBs_caminar(){
    ...
    switch(direcion_anima){
        ...
        case 1: ///Derecha;
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, animacion_caminar.gets_cont() * DESPLAZAR_Y_PIXEL, 1 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
        ...
        case 3: ///Arriba;
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, animacion_caminar.gets_cont() * DESPLAZAR_Y_PIXEL, 2 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
        ...
        case 4: ///Abajo;
            blit(ENEMIGO_2_spr, ENEMIGO_1_mov_spr, animacion_caminar.gets_cont() * DESPLAZAR_Y_PIXEL, 0 * DESPLAZAR_X_PIXEL, 0, 0,  TAMANO_Y_SPRITE, TAMANO_X_SPRITE);
            draw_sprite(buffer, ENEMIGO_1_mov_spr, gets_pocicion_y_juego() * TAMANO_Y_SPRITE + ESPACIO_SUPERIOR_Y, gets_pocicion_x_juego() * TAMANO_X_SPRITE - frame_estatico.gets_cont() * TAMANO_X_SPRITE_INT + ESPACIO_SUPERIOR_X);
        break;
...
void ENEMIGO_2::Graficar_flechas(){
...
#endif // CLASE_PERSONAJE_ENEMIGO_2_GRAFICOS_H_INCLUDED
