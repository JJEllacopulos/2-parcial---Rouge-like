...
void asignar_sprites(){
    ...
    ENEMIGO_3_spr = load_bitmap("Imagenes/Enemigo_3.bmp", NULL);
    ENEMIGO_3_mov_spr = create_bitmap(TAMANO_X_SPRITE, TAMANO_Y_SPRITE);

    ENEMIGO_4_spr = load_bitmap("Imagenes/Enemigo_4.bmp", NULL);
